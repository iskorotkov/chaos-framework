...
kubectl apply -f https://litmuschaos.github.io/litmus/litmus-operator-v1.9.0.yaml -n litmus
...
kubectl apply -f https://litmuschaos.github.io/litmus/litmus-admin-rbac.yaml -n litmus
